        ...
        <div className="grid grid-cols-2 items-start gap-10 antialiased gap-y-24  lg:grid-cols-1">
          ...
          >
            ...
            <p className="text-slate-400 text-sm md:text-xs xs:text-[0.55rem]">
              ...
              implemented flexible grid systems, adaptive styling. This project
              helped me build a strong foundation in responsive web design,
              allowing me to create visually consistent and user-friendly
              websites.
            </p>

            <a
              className="flex items-center text-xl underline underline-offset-4 italic hover:text-green-700"
              href="https://github.com/KenTubio/tubio_portfolio/blob/master/dist/projects/landing-page.html"
              target="_blank"
            >
              <LuGithub />
              Source Code
